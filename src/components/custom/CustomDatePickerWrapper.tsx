...
const CustomDatePickerWrapper = styled(Box)<BoxProps>(({ theme }) => {
  return {
    ...
    '& .react-datepicker': {
      ...
      '& .react-datepicker__day--in-range, & .react-datepicker__day--in-selecting-range':
        {
          ...
          backgroundColor: `${'rgb(247, 43, 115, 0.06)'} !important`,
        },
      '& .react-datepicker__day--today': {
        ...
        '&:not(.react-datepicker__day--selected):not(:empty)': {
          ...
          '&:hover': {
            backgroundColor: 'rgb(247, 43, 115, 0.04)',
          },
          '&.react-datepicker__day--keyboard-selected': {
            backgroundColor: 'rgb(247, 43, 115, 0.06)',
            '&:hover': {
              backgroundColor: 'rgb(247, 43, 115, 0.06)',
            },
          },
      ...
      '& .react-datepicker__day--keyboard-selected': {
        '&:not(.react-datepicker__day--in-range)': {
          backgroundColor: `rgba(247, 43, 115, 0.06)`,
          '&:hover': {
            backgroundColor: `rgba(247, 43, 115, 0.06)`,
          },
        },
