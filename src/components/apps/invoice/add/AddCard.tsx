...
import { InvoiceTabType } from '../../../../types/apps/invoiceTypes';
...
const AddCard = (props: Props) => {
  // ** Props
  const { setValue, control, errors, formValues, invoiceData, invoiceStore } =
    props;
  ...
  const calculateFinalTotal = () => {
    ...
    const total = subtotal + aplicableTax;
    ...
    <Card>
                ...
                <Controller
                  ...
                  render={({ field: { value, onChange } }) => (
                    <TextField
                      ...
                      onChange={(e) => {
                        onChange(e);
                        calculateFinalTotal(); // Recalculate total on tax change
                      }}
                    />
                  )}
                />
      ...
      <CardContent sx={{ px: [6, 10] }}>
        <InputLabel
          ...
          sx={{ mb: 2, fontWeight: 500, fontSize: '0.875rem' }}
        >
          Note:
        </InputLabel>
        <TextField
      ...
      <AddActions invoiceStore={invoiceStore} />
    </Card>
  );
};
