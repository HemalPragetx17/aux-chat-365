...
export const PRIMARY_COLOR = '#a953df';

export const PAYMENT_STATUS = {
  PENDING: { name: 'Due', color: 'warning' },
  SUCCESS: { name: 'Received', color: 'success' },
...
export const BUTTON_ELEMENTS = ['svg', 'path', 'button'];

export const AI_OPTION_ELEMENTS = [
  {
    label: 'Friendly',
    value: 'Friendly',
  },
...
export const CONTRACT_STATUS = {
  SIGNED: { name: 'SIGNED', color: 'success' },
  SENT: { name: 'SENT', color: 'primary' },
  OPENED: { name: 'OPENED', color: 'warning' },
};
